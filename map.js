...
function initMap() {
  ...
  if (!clientId || clientId === 'YOUR_CLIENT_ID') {
    ...
    if (mapEl) {
      mapEl.innerHTML = [
        '<a href="https://map.naver.com/v5/search/부천시%20성주로%20200번길%2021%20꿀잼영어" target="_blank" rel="noopener" class="map-fallback">',
        '  <span class="map-fallback__inner">',
        '    <span class="map-fallback__pin" aria-hidden="true">📍</span>',
        '    <span class="map-fallback__copy">',
        '      <span class="map-fallback__title">네이버 지도</span>',
        '      <span class="map-fallback__sub">꿀잼영어 위치 보기</span>',
        '    </span>',
        '    <span class="map-fallback__chev" aria-hidden="true">›</span>',
        '  </span>',
        '</a>'
      ].join('');
    }
